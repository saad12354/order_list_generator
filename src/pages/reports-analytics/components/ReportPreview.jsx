...
const ReportPreview = ({ reportData, onExport, onPrint, onShare }) => {
  ...
  const mockInventoryItems = [
    { category: '🔧 Copper Pipes', item: '1/4" Soft Copper Pipe', quantity: '25 ft', status: 'In Stock', emoji: '✅' },
    { category: '🔧 Copper Pipes', item: '3/8" Hard Copper Pipe', quantity: '50 ft', status: 'Low Stock', emoji: '⚠️' },
    { category: '🧊 Insulation', item: '1/4" x 9mm Insulation', quantity: '100 ft', status: 'In Stock', emoji: '✅' },
    { category: '🔩 Pipe Fittings', item: '1/4" Elbow Fitting', quantity: '15 pcs', status: 'In Stock', emoji: '✅' },
    { category: '🔗 Flare Nuts', item: '3/8" Flare Nut', quantity: '8 pcs', status: 'Low Stock', emoji: '⚠️' },
    { category: '⚡ Electrical Wires', item: '2.5 sq mm - 4 Core Wire', quantity: '200 ft', status: 'In Stock', emoji: '✅' },
    { category: '🔨 Tools', item: 'Flaring Tool Set', quantity: '1 set', status: 'Available', emoji: '🔧' },
    { category: '🧪 Materials', item: 'Brazing Rods', quantity: '10 pcs', status: 'In Stock', emoji: '✅' }
  ];
  ...
  const generateEnhancedReport = () => {
    ...
    mockInventoryItems?.forEach((item, index) => {
      ...
      inventorySection += `   ${item?.emoji} Status: ${item?.status}\n\n`;
    });

    const notesSection = reportData?.notes ? `📝 ADDITIONAL NOTES:\n${reportData?.notes}\n\n` : '';
    
    const footerSection = `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n🛠️ Generated by HVAC Inventory Manager v1.0.0\n📱 Professional HVAC Documentation System\n📧 Contact: support@hvac-manager.com`;
        ...
        <div className="bg-background border border-border rounded-lg p-6 font-mono text-sm">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      ...
                      <span className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs ${
                        ...
                        item?.status === 'Available'? 'bg-blue-50 text-blue-600' : 'bg-success/10 text-success'
                      }`}>
          ...
          <div className="border-t border-border pt-4 mt-6 text-center text-xs text-muted-foreground">
            <div className="space-y-1">
              <p>🛠️ Generated by HVAC Inventory Manager v1.0.0</p>
              <p>📱 Professional HVAC Documentation System</p>
              <p>📧 Contact: support@hvac-manager.com</p>
            </div>
          </div>
        </div>
      </div>
